...
import { deriveDominantFitmentResult } from "@mototwin/domain";

/** Спека §11: «N владельцев» / «владельца». */
...
/** Спека §14 — варианты подтипа источника. */
...
/** Спека §10 — поясняющие абзацы под заголовком итога. */
export function verdictSupportParagraphsRu(d: PartCompatibilityReportWire): string[] {
  ...
  switch (st) {
    ...
    case "LOW_CONFIDENCE":
      return [
        "Данных по отчётам пока мало или они неоднородны — вывод по совместимости осторожный.",
      ];
