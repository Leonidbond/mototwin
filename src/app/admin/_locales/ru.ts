...
export const ruAdmin = {
  ...
  feedback: {
    ...
    export: "Экспорт NDJSON",
    exportSelected: (n: number) => `Экспорт выбранных (${n})`,
    empty: "Обращений не найдено",
    detail: {
      back: "← Назад к списку обращений",
      context: "Контекст",
      message: "Сообщение",
      author: "Автор",
      manage: "Обработка обращения",
      note: "Комментарий администратора",
      save: "Сохранить",
      saved: "Сохранено.",
      noPermission: "Менять статус могут только Super Admin и Moderator.",
      reviewedBy: "Обработал",
      openUser: "Открыть пользователя",
      openVehicle: "Открыть мотоцикл",
    },
  },
} as const;
