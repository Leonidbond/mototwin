...
Implemented routes:
- Catalog (4 уровня, см. [data-model.md](./data-model.md)): `/api/motorcycle-brands`, `/api/motorcycle-model-families`, `/api/motorcycle-variants`, `/api/motorcycle-generations`
