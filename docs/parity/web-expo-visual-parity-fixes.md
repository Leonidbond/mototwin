...
- **Expo гараж:** строка «Текущий API: …» на экране ошибки показывается **только в development** (`__DEV__`); в production-сборке скрыта, пользовательские сообщения об ошибке сохраняются (см. [frontend-expo.md](../frontend-expo.md) §4.1).
