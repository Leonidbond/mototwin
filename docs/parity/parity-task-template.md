...
<!-- Какие docs обновить или создать; где зафиксировать gap. Для паритета: новые файлы — в `docs/parity/`; при необходимости обновить `docs/parity/cross-platform-parity.md`, `docs/parity/web-expo-parity-audit.md` (краткий статус/ссылка), `docs/parity/web-expo-parity-audit-repeat-2.md` или тематический `docs/parity/web-expo-*-fixes.md`; контракты — `docs/shared-form-contracts.md`, `docs/shared-design-tokens.md` и т.п. -->
