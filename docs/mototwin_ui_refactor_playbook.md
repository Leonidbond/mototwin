...
Правило: если задача формулируется как "красить иконку", цвет применяется к самой иконке, а не к круглой подложке вокруг нее.
...
- В карточках `Состояние узлов` агрегированный статус группы красит саму иконку группы. Бейджи внутри карточки подписаны названием конкретного узла и красятся статусом этого узла.
- Поверхность top-node карточки не является кнопкой. Иконка группы открывает дерево с подсветкой всех `SOON` / `OVERDUE` узлов этой группы; бейдж конкретного узла открывает дерево сфокусированным на этом узле.
