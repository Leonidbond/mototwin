...
- **Notes:** отдельного экрана/модалки «План обслуживания» нет; существующие действия узлов и модалка пояснения статуса сохранены. См. [upcoming-maintenance-mvp.md](./upcoming-maintenance-mvp.md).
