...
- **Parity status:** aligned as personal dashboard semantics (`Мой гараж`) with existing garage cards, shared summary meaning, unchanged vehicle-detail navigation, and profile entry point from Garage header.
