...
- **Notes:** both show list states and navigation to vehicle detail; visual composition differs.
...
- **Parity status:** aligned by business outcome
- **Notes:** both support reading `SERVICE` and `STATE_UPDATE`, filtering/sorting and grouped understanding.
